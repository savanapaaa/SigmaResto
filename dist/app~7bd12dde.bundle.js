  ...
  [193],
  {
    ...
    /***/ 3819: /***/ () => {
      ...
      var skipContent = /*#__PURE__*/ (function (_HTMLElement) {
        ...
        var _super = _createSuper(skipContent);
    ...
    /***/ 2186: /***/ (
      ...
      /* harmony import */ var idb__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(4424);
      /* harmony import */ var _global_config__WEBPACK_IMPORTED_MODULE_1__ =
      ...
      var DATABASE_NAME =
          _global_config__WEBPACK_IMPORTED_MODULE_1__ /* ["default"].DATABASE_NAME */
            .Z.DATABASE_NAME,
        DATABASE_VERSION =
          _global_config__WEBPACK_IMPORTED_MODULE_1__ /* ["default"].DATABASE_VERSION */
            .Z.DATABASE_VERSION,
        OBJECT_STORE_NAME =
          _global_config__WEBPACK_IMPORTED_MODULE_1__ /* ["default"].OBJECT_STORE_NAME */
            .Z.OBJECT_STORE_NAME;
      var dbPromise = (0, idb__WEBPACK_IMPORTED_MODULE_0__ /* .openDB */.X3)(
        DATABASE_NAME,
        DATABASE_VERSION,
        {
                  ...
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 4:
                      return _context.abrupt(
                        'return',
                        _context.sent.get(OBJECT_STORE_NAME, id),
                      );
                    case 5:
                    case 'end':
                  ...
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 2:
                      return _context2.abrupt(
                        'return',
                        _context2.sent.getAll(OBJECT_STORE_NAME),
                      );
                    case 3:
                    case 'end':
                  ...
                  switch ((_context3.prev = _context3.next)) {
                    ...
                    case 4:
                      return _context3.abrupt(
                        'return',
                        _context3.sent.put(OBJECT_STORE_NAME, restaurant),
                      );
                    case 5:
                    case 'end':
                  ...
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 2:
                      return _context4.abrupt(
                        'return',
                        _context4.sent['delete'](OBJECT_STORE_NAME, id),
                      );
                    case 3:
                    case 'end':
                  ...
                  switch ((_context5.prev = _context5.next)) {
                    ...
                    case 2:
                      return _context5.abrupt(
                        'return',
                        _context5.sent.filter(function (restaurant) {
                          var loweredCaseRestaurantTitle = (
                            restaurant.name || '-'
                          ).toLowerCase();
                          var jammedRestaurantTitle =
                            loweredCaseRestaurantTitle.replace(/\s/g, '');
                          var loweredCaseQuery = query.toLowerCase();
                          var jammedQuery = loweredCaseQuery.replace(/\s/g, '');
                          return (
                            jammedRestaurantTitle.indexOf(jammedQuery) !== -1
                          );
                        }),
                      );
                    case 3:
    ...
    /***/ 9651: /***/ (
      ...
      var config = __webpack_require__(9699); // CONCATENATED MODULE: ./src/scripts/global/api-endpoint.js
      var API_ENDPOINT = {
        RESTAURANT_LIST: ''.concat(
          config /* default.BASE_URL */.Z.BASE_URL,
          'list',
        ),
        DETAIL_RESTAURANT: function DETAIL_RESTAURANT(id) {
          return ''
            .concat(config /* default.BASE_URL */.Z.BASE_URL, 'detail/')
            .concat(id);
        },
        POST_REVIEW: ''.concat(
          config /* default.BASE_URL */.Z.BASE_URL,
      ...
      /* harmony default export */ const api_endpoint = API_ENDPOINT; // CONCATENATED MODULE: ./src/scripts/data/restaurantdb-source.js
      function _typeof(o) {
        '@babel/helpers - typeof';
        return (
          (_typeof =
        ...
        _createClass(RestaurantDbSource, null, [
          {
            key: 'restaurantList',
            value: (function () {
              var _restaurantList = _asyncToGenerator(
                /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
          ...
          },
          {
            ...
            value: (function () {
              var _detailRestaurant = _asyncToGenerator(
          ...
          },
          {
            ...
            value: (function () {
              var _postRestaurantReview = _asyncToGenerator(
                /*#__PURE__*/ _regeneratorRuntime().mark(
                  function _callee3(data) {
      ...
      /* harmony default export */ const restaurantdb_source =
        RestaurantDbSource;
    ...
    /***/ 5018: /***/ (
      ...
      'use strict';
      module.exports = __webpack_require__.p + 'aa6581159e60eae64e59.jpg';
