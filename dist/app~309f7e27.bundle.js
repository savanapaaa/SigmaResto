  ...
  [924],
  {
    /***/ 6042: /***/ (
      ...
      var FavoriteRestaurantSearchPresenter = /*#__PURE__*/ (function () {
        ...
        _createClass(FavoriteRestaurantSearchPresenter, [
          ...
          },
          {
            ...
            value: (function () {
              var _searchRestaurant2 = _asyncToGenerator(
                /*#__PURE__*/ _regeneratorRuntime().mark(
                  function _callee(latestQuery) {
                        ...
                        while (1)
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              _context.next = 4;
                              return this._favoriteRestaurants.searchRestaurants(
                                this.latestQuery,
                              );
                            case 4:
      ...
      /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
        FavoriteRestaurantSearchPresenter;
    ...
    /***/ 4768: /***/ (
      ...
      /* harmony import */ var _templates_template_creator__WEBPACK_IMPORTED_MODULE_0__ =
            ...
            value: function showFavoriteRestaurants() {
              ...
              if (restaurants.length) {
                html = restaurants.reduce(function (carry, restaurant) {
                  return carry.concat(
                    (0,
                    _templates_template_creator__WEBPACK_IMPORTED_MODULE_0__ /* .createRestaurantListTemplate */.gH)(
                      restaurant,
                    ),
                  );
                }, '');
              ...
              document
                ...
                .dispatchEvent(new Event('lists:updated'));
            },
          },
          {
    ...
    /***/ 6840: /***/ (
        ...
        _createClass(FavoriteRestuarantShowPresenter, [
          {
            ...
            value: (function () {
              var _showFavoriteRestaurants2 = _asyncToGenerator(
      ...
      /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
        FavoriteRestuarantShowPresenter;
    ...
    /***/ 4150: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ $G: () =>
          /* binding */ createCustomerReviewFormTemplate,
        /* harmony export */ Cx: () =>
          /* binding */ createCustomerReviewTemplate,
        /* harmony export */ HR: () =>
          /* binding */ createUnlikeRestaurantButtonTemplate,
        /* harmony export */ SF: () =>
          /* binding */ createLikeRestaurantButtonTemplate,
        /* harmony export */ YF: () =>
          /* binding */ createRestaurantDetailTemplate,
        /* harmony export */ gH: () =>
          /* binding */ createRestaurantListTemplate,
        /* harmony export */
      });
      /* harmony import */ var _global_config__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(9699);
      /* harmony import */ var _utils_detail_helper__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(6743);
      /* eslint-disable import/no-cycle */

      var createRestaurantDetailTemplate =
        function createRestaurantDetailTemplate(restaurant) {
          return '\n<img class="restaurant-picture lazyload" crossorigin="anonymous" alt="'
            .concat(restaurant.name, '" data-src="')
            .concat(
              _global_config__WEBPACK_IMPORTED_MODULE_0__ /* ["default"].BASE_IMAGE_URL */
                .Z.BASE_IMAGE_URL + restaurant.pictureId,
            ...
            .concat(
              restaurant.categories
                .map(function (category) {
                  return '<span class="restaurant-category-title">'.concat(
                    category.name,
                    '</span>',
                  );
                })
            ...
            .concat(
              restaurant.menus.foods
                .map(function (food) {
                  return '<li><p><i class="fa-solid fa-utensils"></i>  '.concat(
                    food.name,
                    '</p></li>',
                  );
                })
            ...
            .concat(
              restaurant.menus.drinks
                .map(function (drink) {
                  return '<li><p><i class="fas fa-cocktail"></i>  '.concat(
                    drink.name,
                    '</p></li>',
                  );
                })
            ...
            .concat(
              _utils_detail_helper__WEBPACK_IMPORTED_MODULE_1__ /* ["default"].eachCustomerReview */.Z.eachCustomerReview(
                restaurant,
              ),
              '\n',
            );
        };
      var createCustomerReviewTemplate = function createCustomerReviewTemplate(
        customerReview,
      ) {
        return '\n<div class="detailRestaurant-review">\n    <div class="restaurant-review" id="restaurant-review">\n        <div class="review-header">\n            <p class="review-name"><i class="far fa-user"></i>  '
          .concat(
            customerReview.name,
            '</p>\n            <p class="review-date">',
          )
          ...
          .concat(customerReview.review, '</p>\n        </div>\n    </div>\n');
      };
      var createRestaurantListTemplate = function createRestaurantListTemplate(
        restaurant,
      ) {
        return '\n    <article class="list-item">\n    <a href="#/detail/'
          .concat(
            restaurant.id,
            '">\n          <div class="list-thumbnail">\n              <img class="list-item__thumbnail lazyload" tabindex="0" class="card-image" crossorigin="anonymous" alt="',
          )
          .concat(restaurant.name || '-', '" data-src="')
          .concat(
            _global_config__WEBPACK_IMPORTED_MODULE_0__ /* ["default"].BASE_IMAGE_URL */
              .Z.BASE_IMAGE_URL + restaurant.pictureId,
            '"/>\n              <p class="list-item_rate"><i title="ratings" class="fa fa-star card-rating"></i>  ',
          )
          .concat(
            restaurant.rating || '-',
      ...
      var createCustomerReviewFormTemplate =
        function createCustomerReviewFormTemplate() {
      ...
      var createLikeRestaurantButtonTemplate =
        function createLikeRestaurantButtonTemplate() {
          return '\n  <button aria-label="like this restaurant" id="likeButton" class="like">\n  <i class="far fa-heart" aria-hidden="true"></i>\n  </button>\n';
        };
      var createUnlikeRestaurantButtonTemplate =
        function createUnlikeRestaurantButtonTemplate() {
